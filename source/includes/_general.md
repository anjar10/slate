...
curl_setopt($ch, CURLOPT_URL, "https://flip.id/api-external/v1/general/banks");
...
```shell
curl https://flip.id/api-external/v1/general/banks \
    -u <secret_key>: 
```
...
curl_setopt($ch, CURLOPT_URL, "https://flip.id/api-external/v1/general/operational");
curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
curl_setopt($ch, CURLOPT_HEADER, FALSE);
...
```shell
curl https://flip.id/api-external/v1/general/operational \
    -u <secret_key>: 
```
...
curl_setopt($ch, CURLOPT_URL, "https://flip.id/api-external/v1/general/maintenance");
curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
curl_setopt($ch, CURLOPT_HEADER, FALSE);
...
```shell
curl https://flip.id/api-external/v1/general/maintenance \
    -u <secret_key>: 
```
